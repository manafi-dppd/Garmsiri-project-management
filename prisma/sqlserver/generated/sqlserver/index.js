...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "prisma/sqlserver/generated/sqlserver",
    "sqlserver/generated/sqlserver",
  ]
...
path.join(process.cwd(), "prisma/sqlserver/generated/sqlserver/query_engine-windows.dll.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/sqlserver/generated/sqlserver/schema.prisma")
