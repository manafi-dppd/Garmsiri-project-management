...
-- CreateIndex
CREATE INDEX "bahrebardairprogram_fidranesh_fidtardor_idx" ON "bahrebardairprogram"("fidranesh", "fidtardor");

-- CreateIndex
CREATE INDEX "bahrebardairprogram_tedad_idx" ON "bahrebardairprogram"("tedad");

-- CreateIndex
CREATE INDEX "bahrebardairprogramseghli_fidranesh_fidtardor_idx" ON "bahrebardairprogramseghli"("fidranesh", "fidtardor");

-- CreateIndex
CREATE INDEX "trikhdorekesht_fiddahe_idx" ON "trikhdorekesht"("fiddahe");

-- CreateIndex
CREATE INDEX "trikhdorekesht_fiddec_idx" ON "trikhdorekesht"("fiddec");

-- CreateIndex
CREATE INDEX "bahrebardaritaghvim_fidtardor_fidranesh_idx" ON "bahrebardaritaghvim"("fidtardor", "fidranesh");

-- CreateIndex
CREATE INDEX "idx_network_network" ON "network"("network");

-- CreateIndex
CREATE UNIQUE INDEX "unique_sal_mah_dahe" ON "salmahdahe"("sal", "mah", "dahe");

-- CreateIndex
CREATE INDEX "idx_systempart_part" ON "systempart"("part");
...
-- CreateIndex
CREATE UNIQUE INDEX "access_level_positionId_menuId_key" ON "access_level"("position_id", "menu_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "invitation_userId_key" ON "invitation"("user_id");

-- CreateIndex
CREATE INDEX "invitation_mobile_idx" ON "invitation"("mobile");

-- CreateIndex
CREATE INDEX "invitation_username_idx" ON "invitation"("username");

-- CreateIndex
CREATE UNIQUE INDEX "invitation_access_invitationId_menuId_key" ON "invitation_access"("invitation_id", "menu_id");
...
-- CreateIndex
CREATE UNIQUE INDEX "user_access_user_id_menu_id_key" ON "user_access"("user_id", "menu_id");
...
-- AddForeignKey
ALTER TABLE "position_network" ADD CONSTRAINT "position_network_fidposition_fkey" FOREIGN KEY ("fidposition") REFERENCES "position"("id") ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "position_network" ADD CONSTRAINT "position_network_network_fk" FOREIGN KEY ("fidnetwork") REFERENCES "network"("idnet") ON DELETE NO ACTION ON UPDATE NO ACTION;
